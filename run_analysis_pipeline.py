...
SEASON_DEFINITIONS = {
    'winter_spring': {'start_month': 11, 'start_day': 15, 'end_month': 3, 'end_day': 10, 'year_offset': -1}, # Bắt đầu từ 15/11/ (Năm Y-1)
    'summer_autumn': {'start_month': 4, 'start_day': 15, 'end_month': 8, 'end_day': 15, 'year_offset': 0},  # Bắt đầu từ 15/04/ (Năm Y)
    'main_season':   {'start_month': 9, 'start_day': 15, 'end_month': 12, 'end_day': 15, 'year_offset': 0}   # Bắt đầu từ 15/09/ (Năm Y)
}
